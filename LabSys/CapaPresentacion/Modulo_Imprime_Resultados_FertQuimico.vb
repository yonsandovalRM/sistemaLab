...
Module Modulo_Imprime_Resultados_FertQuimico
    ...
    Public Sub Genera_Impresion_FertQuimico(ByVal OTResultado As Integer, ByVal NLabD As Integer, ByVal NLabH As Integer)
        ...
        fuente = "F:\Archivos LabSys\Formatos Labsys\Formatos Resultados.xls"
        NLabDesde = NLabD
        NLabHasta = NLabH
        Filas_Pagina = 65
        ...
        End With
        If Retorno = 1 Then
            sRutaDest = "F:\Archivos LabSys\Resultados\" + sAño + ".FertQimicos-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & ".xls"
        Else
            sRutaDest = "F:\Archivos LabSys\Resultados\" + sAño + ".FertQimicos-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & " NumOrden " & OrdenEnResulatdos & ".xls"
        End If
        'sRutaDest = "F:\Mis Documentos\LabSys-Pruebas\" + sAño + ".FertQimicos-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & " (Fis).xls"
        ...
        Try
            For Each Fila_Ciclo In Cjto_Tablas1.Tables("TABLA_CICLO").Rows
                ...
                If SALTO_PAGINA = True Or Cuenta_Columnas > Maximo_columnas Then
                    Call Coloca_Columnas_FertQuimico(Cuenta_Columnas)
...
SaltoxCicloInicial:
    ...
    Private Sub Coloca_Columnas_FertQuimico(ByVal cuenord As Integer)
    ...
    Private Sub Imprime_Encabezado(ByVal HOJA_EXCEL As Excel.Worksheet, ByVal pagina As Integer, ByRef fila As Integer, ByRef Fila_Firma As Integer, ByVal OTResultado As Integer)
        ...
        HOJA_EXCEL.Pictures.Insert("F:\Archivos LabSys\Imagenes\Logo  mediano Agro.jpg").Select()
        ...
        HOJA_EXCEL.Range("AH" & fila.ToString).Value = "FERTILIZANTES QUIMICOS"
            ...
            For Each Fila_Nlab In Cjto_Tablas1.Tables("NLAB_COLUMNAS").Rows
                ...
                If (Fila_DigRes Is Nothing) = False Then
                    ...
                    If Fila_Elemento("ELE_PROCESO") = "SubAnalisis" Then
                        ...
                        If Fila_Elemento("ELE_CODIGO") = "WGran 6tamizes" Then Call Imprime_SubAnalisis_Granulometria6TamicesQuiOrg(ExcelA, HOJA_EXCEL, Fila, Fila_Nlab("OT_NLAB"), COLD, COLH, COLDC, COLHC, COLDS, COLHS)
                        SubTitulo_Aux = ""
