...
Public Class ReporteOTporFacturar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteOTporFacturar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteOTporFacturar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteOTporFacturar = New ReporteOTporFacturar
        rpt.Site = Me.Site
        Return rpt
    End Function
