...
Public Class ReporteCentroCostoDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteCentroCostoDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCentroCostoDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCentroCostoDetalle = New ReporteCentroCostoDetalle
        rpt.Site = Me.Site
        Return rpt
    End Function
