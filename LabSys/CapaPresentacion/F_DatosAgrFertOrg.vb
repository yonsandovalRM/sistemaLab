Public Class F_DatosAgrFertOrg

    Private Sub F_DatosAgrFertOrg_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        While i < r
            If orden.dgDatosAgronomicos.Rows.Item(i).Cells.Item(0).Value > 6000 And orden.dgDatosAgronomicos.Rows.Item(i).Cells.Item(0).Value < 7000 Then
    ...
    Private Sub dgDatArgFertOrg_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgDatArgFertOrg.CellClick
        Try
            ...
            Me.txIdentificacion1.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(1).Value
            Me.txIdentificacion2.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(2).Value
            Me.txPredio.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(3).Value
            Me.cbMuestreador.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(6).Value
            Me.dtMuestreador.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(7).Value
            Me.cbLocalidad.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(4).Value
            Me.cbTeipoFert.Text = Me.dgDatArgFertOrg.Rows(e.RowIndex).Cells.Item(5).Value
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        orden.txIvaRe.Text = CInt(CInt(orden.txNetoRe.Text) * 0.19)

        Dim f, g As Decimal
        f = orden.txNetoRe.Text
        g = orden.txIvaRe.Text
        orden.txTotalRe.Text = CInt(f + g)
    ...
    Private Sub btnAceptarOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptarOK.Click
        ...
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(1).Value = Me.txIdentificacion1.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(2).Value = Me.txIdentificacion2.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(3).Value = Me.txPredio.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(6).Value = Me.cbMuestreador.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(7).Value = Me.dtMuestreador.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(4).Value = Me.cbLocalidad.Text
        Me.dgDatArgFertOrg.Rows.Item(i).Cells.Item(5).Value = Me.cbTeipoFert.Text
        ...
        If i + 1 < Me.dgDatArgFertOrg.Rows.Count Then
            ...
            If Me.dgDatArgFertOrg.Rows.Item(i + 1).Cells.Item(1).Value <> "" Then
                ...
                Me.txIdentificacion1.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(1).Value
                Me.txIdentificacion2.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(2).Value
                Me.txPredio.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(3).Value
                Me.cbMuestreador.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(6).Value
                Me.dtMuestreador.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(7).Value
                Me.cbLocalidad.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(4).Value
                Me.cbTeipoFert.Text = Me.dgDatArgFertOrg.Rows(i + 1).Cells.Item(5).Value
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For Each fila In Me.dgDatArgFertOrg.Rows
            etiqueta.Imprimir_Etiqueta1("192.168.0.69", "443", "Tipo Fert: " & fila.Cells(7).Value.ToString, "", "N: " & fila.Cells(0).Value.ToString, "Agrolab " & Today) '"Origen: " & vaOrigen, fila.Cells(7).Value.ToString, , fila.Cells(0).Value.ToString)
