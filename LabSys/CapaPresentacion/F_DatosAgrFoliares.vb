Public Class F_DatosAgrFoliares
    ...
    Private Sub F_DatosAgrFoliares_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.dgDatArgFoliares.Rows.Clear()

        i = 0
        r = orden.dgDatosAgronomicos.Rows.Count

        While i < r
            If orden.dgDatosAgronomicos.Rows.Item(i).Cells.Item(0).Value > 1000 And orden.dgDatosAgronomicos.Rows.Item(i).Cells.Item(0).Value < 2000 Then
                ...
                While desde <= nlabHasta
                    ...
                    If Me.dgDatArgFoliares.Rows.Count = 0 Then
                        If dsArg.Tables(0).Rows.Count = 0 Then
                            ...
                            Me.dgDatArgFoliares.Rows.Add(dgvRow)
                    ...
                    Else
                        ...
                        t = Me.dgDatArgFoliares.Rows.Count
                        u = 0
                        s = 0
                        While s < t
                            If Me.dgDatArgFoliares.Rows.Item(s).Cells.Item(0).Value = desde Then
                                u = 1
                            End If
                            s = s + 1
                        End While
        ...
        If Me.dgDatArgFoliares.Rows.Count <> 0 Then
            Me.txNlab.Text = Me.dgDatArgFoliares.Rows.Item(0).Cells.Item(0).Value
        End If
    ...
    Private Sub dgDatArgFoliares_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgDatArgFoliares.CellClick
        Try

            Me.txNlab.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(0).Value
            'If Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(1).Value.ToString <> "" Then

            Me.txCuartel1.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(1).Value
            Me.txCuartel2.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(2).Value
            Me.cbTejido.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(3).Value
            Me.cbEspecie.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(4).Value
            Me.cbVariedad.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(5).Value
            Me.txEdad.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(6).Value
            'rto
            If (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "s/a") Then
                Me.rbRtoSA.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "Bajo") Then
                Me.rbRtoBajo.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "Norma") Then
                Me.rbRtoNorma.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "Normal") Then
                Me.rbRtoNormal.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "+Normal") Then
                Me.rbRtoNormal2.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(7).Value = "Alto") Then
                Me.rbRtoAlto.Checked = True
            End If
            'carga
            If (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "s/a") Then
                Me.rbCarSA.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "Bajo") Then
                Me.rbCarBajo.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "Norma") Then
                Me.rbCarNorma.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "Normal") Then
                Me.rbCarNormal.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "+Normal") Then
                Me.rbCarNormal2.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(8).Value = "Alto") Then
                Me.rbCarAlto.Checked = True
            End If
            'vig
            If (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "s/a") Then
                Me.rbVigSA.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "Bajo") Then
                Me.rbVigBajo.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "Norma") Then
                Me.rbVigNorma.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "Normal") Then
                Me.rbVigNormal.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "+Normal") Then
                Me.rbVigNormal2.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(9).Value = "Alto") Then
                Me.rbVigAlto.Checked = True
            End If
            'den
            If (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(10).Value = "s/a") Then
                Me.rbDenSA.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(10).Value = "Baja") Then
                Me.rbDenBaja.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(10).Value = "Tradicional") Then
                Me.rbDenTradicional.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(10).Value = "Alta") Then
                Me.rbDenAlta.Checked = True
            End If
            'apa
            If (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(11).Value = "s/a") Then
                Me.rbApaSA.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(11).Value = "Anormal") Then
                Me.rbApaAnormal.Checked = True
            ElseIf (Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(11).Value = "Normal") Then
                Me.rbApaNormal.Checked = True
            End If

            Me.txObservacion.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(14).Value
            Me.cbMuestreador.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(15).Value
            Me.dtMuestreador.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(16).Value
            Me.txPredio.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(17).Value
            Me.cbLocalidad.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(18).Value
            'End If
    ...
    'Private Sub dgDatArgFoliares_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgDatArgFoliares.CellContentClick
    '    Try
    ...
    Private Sub btnAceptarOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptarOK.Click
        ...
        Dim cn As New CapaNegocio
        Dim orden As F_OrdenTrabajo = Me.Owner
        r = Me.dgDatArgFoliares.Rows.Count
        i = 0

        While i < r
            nlab = Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(0).Value
        ...
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(1).Value = Me.txCuartel1.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(2).Value = Me.txCuartel2.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(3).Value = Me.cbTejido.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(4).Value = Me.cbEspecie.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(5).Value = Me.cbVariedad.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(6).Value = Me.txEdad.Text

        If rbRtoBajo.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "Bajo"
            rto = "Bajo"
        ElseIf Me.rbRtoNorma.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "Norma"
            rto = "Norma"
        ElseIf Me.rbRtoNormal.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "Normal"
            rto = "Normal"
        ElseIf Me.rbRtoNormal2.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "+Normal"
            rto = "+Normal"
        ElseIf Me.rbRtoAlto.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "Alto"
            rto = "Alto"
        ElseIf Me.rbRtoSA.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(7).Value = "s/a"
            rto = "s/a"
        End If

        If Me.rbCarBajo.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "Bajo"
            car = "Bajo"
        ElseIf Me.rbCarNorma.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "Norma"
            car = "Norma"
        ElseIf Me.rbCarNormal.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "Normal"
            car = "Normal"
        ElseIf Me.rbCarNormal2.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "+Normal"
            car = "+Normal"
        ElseIf Me.rbCarAlto.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "Alto"
            car = "Alto"
        ElseIf Me.rbCarSA.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(8).Value = "s/a"
            car = "s/a"
        End If

        If Me.rbVigBajo.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "Bajo"
            vig = "Bajo"
        ElseIf Me.rbVigNorma.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "Norma"
            vig = "Norma"
        ElseIf Me.rbVigNormal.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "Normal"
            vig = "Normal"
        ElseIf Me.rbVigNormal2.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "+Normal"
            vig = "+Normal"
        ElseIf Me.rbVigAlto.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "Alto"
            vig = "Alto"
        ElseIf Me.rbVigSA.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(9).Value = "s/a"
            vig = "s/a"
        End If

        If Me.rbDenBaja.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(10).Value = "Baja"
            den = "Baja"
        ElseIf Me.rbDenTradicional.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(10).Value = "Tradicional"
            den = "Tradicional"
        ElseIf Me.rbDenAlta.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(10).Value = "Alta"
            den = "Alta"
        ElseIf Me.rbDenSA.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(10).Value = "s/a"
            den = "s/a"
        End If

        If Me.rbApaAnormal.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(11).Value = "Anormal"
            apa = "Anormal"
        ElseIf Me.rbApaNormal.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(11).Value = "Normal"
            apa = "Normal"
        ElseIf Me.rbApaSA.Checked = True Then
            Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(11).Value = "s/a"
            apa = "s/a"
        End If

        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(12).Value = ""
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(13).Value = ""
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(14).Value = Me.txObservacion.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(15).Value = Me.cbMuestreador.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(16).Value = Me.dtMuestreador.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(17).Value = Me.txPredio.Text
        Me.dgDatArgFoliares.Rows.Item(i).Cells.Item(18).Value = Me.cbLocalidad.Text

        cn.GrabaAntecedentesFoliar(orden.lblNot.Text, Me.txNlab.Text, Me.txPredio.Text, Me.cbLocalidad.Text, _
        ...
        If i + 1 < Me.dgDatArgFoliares.Rows.Count Then
            Me.txNlab.Text = Me.dgDatArgFoliares.Rows.Item(i + 1).Cells.Item(0).Value
            If Me.dgDatArgFoliares.Rows.Item(i + 1).Cells.Item(1).Value <> "" Then

                'Me.txNlab.Text = Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(0).Value
                'If Me.dgDatArgFoliares.Rows(e.RowIndex).Cells.Item(1).Value.ToString <> "" Then

                Me.txCuartel1.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(1).Value
                Me.txCuartel2.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(2).Value
                Me.cbTejido.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(3).Value
                Me.cbEspecie.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(4).Value
                Me.cbVariedad.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(5).Value
                Me.txEdad.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(6).Value
                'rto
                If (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "s/a") Then
                    Me.rbRtoSA.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "Bajo") Then
                    Me.rbRtoBajo.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "Norma") Then
                    Me.rbRtoNorma.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "Normal") Then
                    Me.rbRtoNormal.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "+Normal") Then
                    Me.rbRtoNormal2.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(7).Value = "Alto") Then
                    Me.rbRtoAlto.Checked = True
                End If
                'carga
                If (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "s/a") Then
                    Me.rbCarSA.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "Bajo") Then
                    Me.rbCarBajo.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "Norma") Then
                    Me.rbCarNorma.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "Normal") Then
                    Me.rbCarNormal.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "+Normal") Then
                    Me.rbCarNormal2.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(8).Value = "Alto") Then
                    Me.rbCarAlto.Checked = True
                End If
                'vig
                If (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "s/a") Then
                    Me.rbVigSA.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "Bajo") Then
                    Me.rbVigBajo.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "Norma") Then
                    Me.rbVigNorma.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "Normal") Then
                    Me.rbVigNormal.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "+Normal") Then
                    Me.rbVigNormal2.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(9).Value = "Alto") Then
                    Me.rbVigAlto.Checked = True
                End If
                'den
                If (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(10).Value = "s/a") Then
                    Me.rbDenSA.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(10).Value = "Baja") Then
                    Me.rbDenBaja.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(10).Value = "Tradicional") Then
                    Me.rbDenTradicional.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(10).Value = "Alta") Then
                    Me.rbDenAlta.Checked = True
                End If
                'apa
                If (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(11).Value = "s/a") Then
                    Me.rbApaSA.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(11).Value = "Anormal") Then
                    Me.rbApaAnormal.Checked = True
                ElseIf (Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(11).Value = "Normal") Then
                    Me.rbApaNormal.Checked = True
                End If

                Me.txObservacion.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(14).Value
                Me.cbMuestreador.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(15).Value
                Me.dtMuestreador.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(16).Value
                Me.txPredio.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(17).Value
                Me.cbLocalidad.Text = Me.dgDatArgFoliares.Rows(i + 1).Cells.Item(18).Value
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim vaTejido As String
        Dim etiqueta As New Etiquetas.Etiqueta
        For Each fila In Me.dgDatArgFoliares.Rows
            If fila.Cells(3).Value.ToString = "Lámina" Then
                vaTejido = "Lamina"
            ElseIf fila.Cells(7).Value.ToString = "Hoja" Then
                vaTejido = "Hoja"
            ElseIf fila.Cells(7).Value.ToString = "Peciolo" Then
                vaTejido = "Peciolo"
            ElseIf fila.Cells(7).Value.ToString = "Raiz" Then
                vaTejido = "Raiz"
            End If
            etiqueta.Imprimir_Etiqueta1("192.168.0.69", "443", "Agrolab " & Today, "", "N: " & fila.Cells(0).Value.ToString, "Tejido: " & vaTejido) '"Origen: " & vaOrigen, fila.Cells(7).Value.ToString, , fila.Cells(0).Value.ToString)
