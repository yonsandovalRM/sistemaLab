...
Module Formato_Yemas_30
    Public Sub imprime_informe_Resultado_30(ByVal HOJA_EXCEL As Excel.Worksheet)
        ...
        For Each Fila_Yemas In Cjto_Orden1.Tables("DIG_YEMAS").Rows
            If lab_aux = 0 Then
                Call imprime_encabezado_Resultado_30(Cuenta_Pag, Fila_Yemas("OT_NLAB"), Fila_Yemas("OT_NUMERO"), fila, HOJA_EXCEL)
                Call Imprime_Detalle_Resultado_30(fila, HOJA_EXCEL)
                fila_inicio_borde = fila
                Cuenta = 1 : Cuenta_Pag = 2
            End If
            If lab_aux <> Fila_Yemas("OT_NLAB") And lab_aux <> 0 Then
                Call Imprime_Totales_Resultado_30(TotalObs, TotalFrutal, fila_inicio_borde, fila, HOJA_EXCEL)
                TotalObs = 0 : TotalFrutal = 0
                fila = fila + 2
                Call Imprime_Simbologia_Resultado_30(fila, HOJA_EXCEL)
                fila = fila + 2
                Call Imprime_ComFir_Resultado_30(orden_aux, lab_aux, Cuenta, fila, HOJA_EXCEL)
                fila = 1 + (52 * Cuenta)
                Call imprime_encabezado_Resultado_30(Cuenta_Pag, Fila_Yemas("OT_NLAB"), Fila_Yemas("OT_NUMERO"), fila, HOJA_EXCEL)
                Call Imprime_Detalle_Resultado_30(fila, HOJA_EXCEL)
                fila_inicio_borde = fila
            ...
            If IsDBNull(Fila_Yemas("YEM_CARGADOR2")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR2"), "N", "P", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR3")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR3"), "R", "T", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR4")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR4"), "V", "X", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR5")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR5"), "Z", "AB", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR6")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR6"), "AD", "AF", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR7")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR7"), "AH", "AJ", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR8")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR8"), "AL", "AN", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR9")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR9"), "AP", "AR", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR10")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR10"), "AT", "AV", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR11")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR11"), "AX", "AZ", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR12")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR12"), "BB", "BD", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR13")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR13"), "BF", "BH", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR14")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR14"), "BJ", "BL", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR15")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR15"), "BN", "BP", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR16")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR16"), "BR", "BT", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR17")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR17"), "BV", "BX", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR18")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR18"), "BZ", "CB", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR19")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR19"), "CD", "CF", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR20")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR20"), "CH", "CJ", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR21")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR21"), "CL", "CN", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR22")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR22"), "CP", "CR", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR23")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR23"), "CT", "CV", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR24")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR24"), "CX", "CZ", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR25")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR25"), "DB", "DD", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR26")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR26"), "DF", "DH", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR27")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR27"), "DJ", "DL", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR28")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR28"), "DN", "DP", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR29")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR29"), "DR", "DT", fila)
            If IsDBNull(Fila_Yemas("YEM_CARGADOR30")) = False Then Call COLUMNA_DETALLE(HOJA_EXCEL, Fila_Yemas("YEM_CARGADOR30"), "DV", "DX", fila)
            'Obs nº
        ...
        Call Imprime_Simbologia_Resultado_30(fila, HOJA_EXCEL)
        fila = fila + 2
        Call Imprime_ComFir_Resultado_30(Fila_Yemas("OT_NUMERO"), Fila_Yemas("OT_NLAB"), Cuenta, fila, HOJA_EXCEL)
        HOJA_EXCEL.Range("A11").Select()
    End Sub
    Private Sub Imprime_ComFir_Resultado_30(ByVal orden_aux As Integer, ByVal lab_aux As Integer, ByVal cuenta_pag As Integer, ByRef fila As Integer, ByVal HOJA_EXCEL As Excel.Worksheet)
    ...
    Private Sub Imprime_Totales_Resultado_30(ByVal TotalObs As Integer, ByVal TotalFrutal As Integer, ByVal fila_inicio_borde As Integer, ByRef fila As Integer, ByVal HOJA_EXCEL As Excel.Worksheet)
    ...
    Private Sub Imprime_Simbologia_Resultado_30(ByRef fila As Integer, ByVal HOJA_EXCEL As Excel.Worksheet)
        'SIMBOLOGIA
    ...
    Private Sub Imprime_Detalle_Resultado_30(ByRef fila As Integer, ByVal HOJA_EXCEL As Excel.Worksheet)
        'TITULOS DEL DETALLE *****************
        fila = fila + 1
        'Yema
        ...
        Call COLUMNA_DETALLE(HOJA_EXCEL, "2", "N", "P", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "3", "R", "T", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "4", "V", "X", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "5", "Z", "AB", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "6", "AD", "AF", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "7", "AH", "AJ", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "8", "AL", "AN", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "9", "AP", "AR", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "10", "AT", "AV", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "11", "AX", "AZ", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "12", "BB", "BD", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "13", "BF", "BH", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "14", "BJ", "BL", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "15", "BN", "BP", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "16", "BR", "BT", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "17", "BV", "BX", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "18", "BZ", "CB", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "19", "CD", "CF", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "20", "CH", "CJ", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "21", "CL", "CN", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "22", "CP", "CR", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "23", "CT", "CV", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "24", "CX", "CZ", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "25", "DB", "DD", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "26", "DF", "DH", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "27", "DJ", "DL", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "28", "DN", "DP", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "29", "DR", "DT", fila)
        Call COLUMNA_DETALLE(HOJA_EXCEL, "30", "DV", "DX", fila)
        HOJA_EXCEL.Range("J" & fila.ToString & ":DY" & fila.ToString).BorderAround()
        'Obs nº
        HOJA_EXCEL.Range("DZ" & fila.ToString & ":EE" & fila.ToString).Merge()
    ...
    Private Sub imprime_encabezado_Resultado_30(ByVal CUENTA_PAGINA As Integer, ByVal NLab As Integer, ByVal orden As Integer, ByRef fila As Integer, ByVal HOJA_EXCEL As Excel.Worksheet)
...
continuar:
    ...
    Private Sub impsep_notas_30(ByVal HOJA_EXCEL As Excel.Worksheet, ByRef j As Integer, ByVal query As String)
