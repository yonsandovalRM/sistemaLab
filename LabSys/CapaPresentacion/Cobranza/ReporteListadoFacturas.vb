...
Public Class ReporteListadoFacturas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteListadoFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteListadoFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteListadoFacturas = New ReporteListadoFacturas
        rpt.Site = Me.Site
        Return rpt
    End Function
