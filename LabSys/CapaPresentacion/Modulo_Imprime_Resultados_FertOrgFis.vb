...
Module Modulo_Imprime_Resultados_FertOrgFis
    ...
    Public Sub Genera_Impresion_FertOrgFis(ByVal OTResultado As Integer, ByVal NLabD As Integer, ByVal NLabH As Integer)
        ...
        sAño = CStr(Year(Now))
        sRutaDest = "F:\Mis Documentos\LabSys-Pruebas\" + sAño + ".FertOrg-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & " (Fis).xls"
        ...
        Try
            For Each Fila_Ciclo In Cjto_Tablas1.Tables("TABLA_CICLO").Rows
                ...
                If SALTO_PAGINA = True Or Cuenta_Columnas > Maximo_columnas Then
                    Call Coloca_Columnas_FertOrgFis(Cuenta_Columnas)
...
SaltoxCicloInicial:
    ...
    Private Sub Busca_Datos_Configuracion()
        ...
        With SP
            .Inicializar()
            .AgregarParametro("@TMuestra", 6500, SqlDbType.Int)
    ...
    Private Sub Coloca_Columnas_FertOrgFis(ByVal cuenord As Integer)
