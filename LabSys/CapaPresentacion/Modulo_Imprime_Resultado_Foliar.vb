...
Module Modulo_Imprime_Resultado_Foliar
    ...
    Public Sub Genera_Impresion_Foliar(ByVal OTResultado As Integer, ByVal NLabD As Integer, ByVal NLabH As Integer)
        ...
        If Retorno = 1 Then
            sRutaDest = "F:\Mis Documentos\" + sAño + ".Foliar-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & ".xls"
        Else
            sRutaDest = "F:\Mis Documentos\" + sAño + ".Foliar-Labsys" : destino = sRutaDest & "\" & NLAD & NLAH & "   " & PRO & " NumOrden " & OrdenEnResulatdos & ".xls"
        End If
