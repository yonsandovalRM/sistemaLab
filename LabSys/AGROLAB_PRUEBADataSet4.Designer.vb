...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("AGROLAB_PRUEBADataSet4"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class AGROLAB_PRUEBADataSet4
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As AGROLAB_PRUEBADataSet4 = CType(MyBase.Clone,AGROLAB_PRUEBADataSet4)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "AGROLAB_PRUEBADataSet4"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/AGROLAB_PRUEBADataSet4.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As AGROLAB_PRUEBADataSet4 = New AGROLAB_PRUEBADataSet4
    ...
    Partial Public Class ESTADOS_OTDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddESTADOS_OTRow(ByVal OT As Integer, ByVal Fecha As Date, ByVal Productor As String, ByVal Empresa As String, ByVal Remite As String, ByVal Tipo As String, ByVal Nlab_Desde As Integer, ByVal Estado_Analisis As String, ByVal Estado_Pago As String) As ESTADOS_OTRow
            Dim rowESTADOS_OTRow As ESTADOS_OTRow = CType(Me.NewRow,ESTADOS_OTRow)
            Dim columnValuesArray() As Object = New Object() {OT, Fecha, Productor, Empresa, Remite, Tipo, Nlab_Desde, Estado_Analisis, Estado_Pago}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByOTNlab_Desde(ByVal OT As Integer, ByVal Nlab_Desde As Integer) As ESTADOS_OTRow
            Return CType(Me.Rows.Find(New Object() {OT, Nlab_Desde}),ESTADOS_OTRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnOT, Me.columnNlab_Desde}, true))
    ...
    Partial Public Class ESTADOS_OTRow
        ...
        Public Property Tipo() As String
            Get
                Try 
                    Return CType(Me(Me.tableESTADOS_OT.TipoColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Tipo' de la tabla 'ESTADOS_OT' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsTipoNull() As Boolean
            Return Me.IsNull(Me.tableESTADOS_OT.TipoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetTipoNull()
            Me(Me.tableESTADOS_OT.TipoColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace AGROLAB_PRUEBADataSet4TableAdapters
    ...
    Partial Public Class ESTADOS_OTTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT OT, Fecha, Productor, Empresa, Remite, Tipo, [Nlab Desde], [Estado Analisi"& _ 
                "s], [Estado Pago] FROM dbo.ESTADOS_OT"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As AGROLAB_PRUEBADataSet4.ESTADOS_OTDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As AGROLAB_PRUEBADataSet4.ESTADOS_OTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As AGROLAB_PRUEBADataSet4.ESTADOS_OTDataTable = New AGROLAB_PRUEBADataSet4.ESTADOS_OTDataTable
